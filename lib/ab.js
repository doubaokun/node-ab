...
if(argv.v || argv.verbose)console.log(("Increase " + (force) + " requests per second").green);
var pre_qps = 0;
var traffic = 0;
...
if(argv.v || argv.verbose)console.log(("Milliseconds::" + milliseconds).green);
...
var stats_intv = function() {
  ...
  console.log("REQ NUM: " + stats.req_num.toString().green + " RTN NUM: " + stats.success_num.toString().green + " QPS: " + stats.qps.toString().green + " BODY TRAF: " + stats.traffic_ps.green);
